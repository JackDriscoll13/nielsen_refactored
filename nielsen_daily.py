...
def create_nielsen_reports(daily_data_15min_path:str, daily_data_dayparts_path:str): 
    ...
    config_path = 'NielsenConfigv3.xlsx'
    daypartsorderDict, chartOrderDict, geomappingDict, stationMappingDict, penetrationMappingDict, snNamesDict = report_funcs.get_config_mappings(config_path)
